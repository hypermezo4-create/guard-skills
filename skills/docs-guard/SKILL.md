...
- **Example 1:** To review the README documentation, run:
  ```bash
  docs-guard README.md
  ```

- **Example 2:** To check API documentation:
  ```bash
  docs-guard api_reference.md
  ```

- **Example 3:** For validating changelog entries:
  ```bash
  docs-guard CHANGELOG.md
  ```
